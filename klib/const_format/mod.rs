...
//!
//! Features that require newer versions of Rust, or the nightly compiler,
...
//!
//! [`FormatMarker`]: ./marker_traits/trait.FormatMarker.html
//!
...
pub mod pmr {
    ...
    pub use macros::__concatcp_impl;
